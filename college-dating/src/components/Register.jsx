...
const Register = () => {
  ...
  const validateStep2 = () => {
    ...
    if (!formData.interestedIn) newErrors.interestedIn = 'Please select who you are interested in';
  ...
  const validateStep3 = () => {
    ...
    if (!formData.idPhoto) newErrors.idPhoto = 'Please upload your university ID';
