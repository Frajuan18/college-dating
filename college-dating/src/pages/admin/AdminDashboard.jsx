        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="bg-white rounded-lg shadow overflow-hidden">
            {loading ? (
              ...
              <div className="text-center py-12">
                <p className="text-gray-500 text-lg">No {activeTab} verifications found</p>
              </div>
            ) : (
            ...
            <div className="bg-white max-w-2xl w-full p-6 rounded-lg max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-end">
                  <span className={`px-3 py-1 text-sm font-medium rounded-full ${getStatusBadge(selectedVerification.status)}`}>
