...
const MyProfile = () => {
  ...
  // pages/MyProfile.jsx - Update checkUserAndFetchProfile function
  const checkUserAndFetchProfile = async () => {
    try {
      // Get ONLY the telegram_id from localStorage
  ...
  const addInterest = () => {
    if (
      interestInput.trim() &&
      !editForm.interests.includes(interestInput.trim())
    ) {
      setEditForm((prev) => ({
        ...prev,
    ...
    >
      ...
      <div className="pt-16 sm:pt-20 pb-8 sm:pb-12 px-3 sm:px-4 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8">
          <div>
            <h1
              className={`text-2xl sm:text-3xl md:text-4xl font-bold ${getTextStyles()}`}
            >
              My Profile
            </h1>
        ...
        {/* Main Profile Card */}
        <div
          className={`rounded-xl sm:rounded-2xl shadow-lg overflow-hidden border ${getCardStyles()} mb-4 sm:mb-6`}
        >
          {/* Cover Photo */}
          ...
          <div className="px-4 sm:px-6 pb-4 sm:pb-6">
              ...
              <div className="relative">
                <div className="w-16 h-16 sm:w-24 sm:h-24 rounded-full border-4 border-white overflow-hidden bg-gray-200 shadow-lg">
                  {user?.photo_url ? (
                    ...
                    <div
                      className={`w-full h-full flex items-center justify-center text-xl sm:text-3xl font-bold ${
                        isDark
            ...
            <div className="text-center mb-4 sm:mb-6">
              <h2
                className={`text-xl sm:text-2xl font-bold mb-2 ${getTextStyles()}`}
              >
                {user?.full_name ||
              ...
              {user?.telegram_username && (
                <p
                  className={`text-xs sm:text-sm flex items-center justify-center gap-1 ${getSubtextStyles()}`}
                >
            ...
            <div className="mb-4 sm:mb-6">
              <h3
                className={`text-base sm:text-lg font-semibold mb-2 ${getTextStyles()}`}
              >
                About Me
              </h3>
              {isEditing ? (
                ...
                <p
                  className={`${getSubtextStyles()} leading-relaxed text-sm sm:text-base`}
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
              {/* University */}
              <div
                className={`p-3 sm:p-4 rounded-lg sm:rounded-xl ${isDark ? "bg-gray-700/30" : "bg-gray-50"}`}
              >
                <div className="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
                  <HiOutlineAcademicCap
                    className={`w-4 h-4 sm:w-5 sm:h-5 ${isDark ? "text-rose-400" : "text-rose-500"}`}
                  />
                  <span
                    className={`text-xs sm:text-sm font-medium ${getTextStyles()}`}
                  >
                    University
                  </span>
                </div>
              ...
              >
                ...
                <p
                  className={`text-sm sm:text-base capitalize ${getSubtextStyles()}`}
                >
            ...
            <div className="mb-4 sm:mb-6">
              <h3
                className={`text-base sm:text-lg font-semibold mb-2 sm:mb-3 ${getTextStyles()}`}
              >
                Interests
              </h3>
              {isEditing ? (
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-2">
                  {user?.interests?.length > 0 ? (
                    ...
                    <p className={`${getSubtextStyles()} text-sm`}>
            ...
            {/* Join Date */}
            <div
              className={`text-xs sm:text-sm ${getSubtextStyles()} border-t ${isDark ? "border-gray-700" : "border-gray-200"} pt-3 sm:pt-4`}
            >
        ...
        <div
          className={`grid grid-cols-3 gap-2 sm:gap-4 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 border ${getCardStyles()}`}
        >
          <div className="text-center">
            <div className={`text-lg sm:text-2xl font-bold ${getTextStyles()}`}>
              {stats.profileViews}
            </div>
            <div className={`text-xs sm:text-sm ${getSubtextStyles()}`}>
              Profile Views
            </div>
          </div>
